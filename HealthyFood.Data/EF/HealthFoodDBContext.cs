...
namespace HealthyFood.Data.EF
{
    public partial class HealthFoodDBContext : DbContext
    {
        // đoạn này khi ta triển khai constructor thì ta có thể bỏ [NotNullAttribute]
        public HealthFoodDBContext(DbContextOptions options) : base(options)
        {

        }
        // sau khi triển khai constructor ta sẽ  tạo các data set
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-P5VIDNI\\LETHAISERVER;Initial Catalog=ShopVega;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerAccount>(entity =>
            {
                ...
                entity.Property(e => e.CustomerPass).HasMaxLength(50);
            ...
            modelBuilder.Entity<Customers>(entity =>
            {
                ...
                entity.Property(e => e.CusPassword).HasMaxLength(50);

                entity.Property(e => e.CusUserName).HasMaxLength(50);
            ...
            modelBuilder.Entity<EmployeeAccount>(entity =>
            {
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasConstraintName("FK_EmployeeAccount_Employees");
            });
            ...
            modelBuilder.Entity<Employees>(entity =>
            {
                ...
                entity.Property(e => e.EmagePath).HasMaxLength(255);
            ...
            modelBuilder.Entity<Orders>(entity =>
            {
                ...
                entity.Property(e => e.ShippedHour).HasMaxLength(50);
